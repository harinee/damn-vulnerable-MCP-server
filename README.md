...
CLINE - VSCode Extension refer this [https://docs.cline.bot/mcp-servers/connecting-to-a-remote-server](https://docs.cline.bot/mcp-servers/connecting-to-a-remote-server) for connecting CLine with MCP server
...
It's not stable in windows environment if you don't want to docker please use linux environment I recommend Docker to run the LAB and I am 100% percent sure it works well in docker environment
